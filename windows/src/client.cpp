...
#include "tun.h"  // предположим, здесь объ€влен bool tun_alloc(); и extern WINTUN_SESSION_HANDLE session

extern WINTUN_SESSION_HANDLE session;

// »справленные extern указатели на функции с точным совпадением типов из wintun.h
